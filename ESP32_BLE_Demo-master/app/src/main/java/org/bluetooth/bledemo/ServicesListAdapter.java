...
public class ServicesListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            fields.serviceName = convertView.findViewById(R.id.peripheral_list_services_name);
            fields.serviceUuid = convertView.findViewById(R.id.peripheral_list_services_uuid);
            fields.serviceType = convertView.findViewById(R.id.peripheral_list_service_type);
